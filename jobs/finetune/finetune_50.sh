...
echo "20-shot"
python finetune_50.py --model ResNet10 --method baseline --n_shot 20 --freeze_backbone 
echo "50-shot"
python finetune_50.py --model ResNet10 --method baseline --n_shot 50 --freeze_backbone 
