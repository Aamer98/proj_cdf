...
def sbm_finetune(source_loader, target_loader, target_name , num_epochs, ): 
    ...
    save_dir = '/content/cdfsl-benchmark/logs/'    
    ...
    for epoch in range(num_epochs):
        ...
        print("epoch: {}/{}  |   Train_accuracy = {}    |    Train_loss = {}   ".format(epoch, num_epochs, 100* train_accuracy/2400, 100*train_loss/2400))
        if (epoch % 50==0):
            #utfile = os.path.join(params.checkpoint_dir, '{:d}.tar'.format(epoch))
            torch.save(model, save_dir + '{}_epoch{}_resnet18.tar'.format(target_name, epoch))
...
if __name__=='__main__':
    ...
    base_loader = miniImageNet_few_shot.get_data_loader(mini_imagenet_path, batch_size = 16)
